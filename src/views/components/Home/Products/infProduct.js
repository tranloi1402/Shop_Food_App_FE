...
const infProduct = ({ product, addToCart, loading }) => (
                ...
                : (
                    <div className='md:flex md:items-center'>
                        ...
                        <div className='w-full md:px-12 max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2'>
                            <h1 className='text-gray-700 uppercase py-2 font-bold xl:text-3xl text-2xl'>{product.name}</h1>
                            <h1 className='text-gray-700 py-2 xl:text-xl'>{product.description}</h1>

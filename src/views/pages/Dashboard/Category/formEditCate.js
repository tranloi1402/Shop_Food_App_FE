...
const FormEditCate = ({ data, setData, onSubmit, loading }) => (
    <div className='h-full ml-14 mt-14 mb-10 md:ml-64'>
        <div>
            <h2 className='ml-6 mt-4 text-xl font-semibold text-gray-500'>Cập nhập thông tin danh mục sản phẩm</h2>
        </div>
        {
            loading ? <h1 className='text-xl text-center font-medium my-20'>Đang tải...</h1>
                : (
                    <div className='m-10 p-2 bg-white border rounded-xl shadow-2xl z-10'>
                        ...
                        >
                            ...
                            <button
                                type='submit'
                                className='cursor-pointer py-2 px-4 block mx-6 my-3 text-white
                                            font-bold text-center rounded add focus:outline-none'
                            >
                                Cập nhập
                            </button>
                        </form>
